...
class DemoWindow < Gosu::Window
  ...
  def draw
    ...
    # Gosu.draw_r(50, 50, 100, 50, Gosu::Color::GREEN, ZOrder::TOP, mode=:default)
    # Draw the button text
    if mouse_over_button(mouse_x, mouse_y)
      @button_font.draw("Click me", 60, 60, ZOrder::TOP, 1.0, 1.0, Gosu::Color::BLACK)
      Gosu.draw_rect(52, 52, 100, 50, Gosu::Color::BLACK, ZOrder::MIDDLE, mode=:default)
    else
      @button_font.draw("Click me", 60, 60, ZOrder::MIDDLE, 1.0, 1.0, Gosu::Color::BLACK)
      Gosu.draw_rect(52, 52, 100, 50, Gosu::Color::WHITE, ZOrder::MIDDLE, mode=:default)
    end
    # Draw the mouse_x position
    @info_font.draw("mouse_x: #{mouse_x} mouse_y: #{mouse_y}", 0, 350, ZOrder::TOP, 1.0, 1.0, Gosu::Color::BLACK)
